...
ggsave('./figs/Figure1.jpg', dpi = 300, width = 110, height = 60, units = "mm", bg = "white")
```
...
ggsave("./figs/Figure2.jpg", dpi = 300, width = 200, height = 80, units = "mm")
...
ggsave("./figs/Figure3.jpg", dpi = 300, width = 150, height = 240, units = "mm")
...
ggsave("./figs/Figure4.jpg", dpi = 300, width = 200, height = 120, units = "mm", bg = "white")
...
ggsave("./viz/Figure5.png", dpi = 400, width = 150, height = 160, units = "mm", bg = "white")
ggsave("./figs/Figure5.jpg", dpi = 300, width = 150, height = 160, units = "mm", bg = "white")
```
...
# STATS
nc %>% filter(year == 2017, net_income < 0) %>% arrange(net_income_adj) # 441/3034 reporting counties
nc %>% filter(year == 2002, net_income < 0) %>% arrange(net_income_adj) #413/3032
...
ggsave("./viz/Figure6.png", dpi = 400, width = 220, height = 60, units = "mm", bg = "white")
ggsave("./figs/Figure6.jpg", dpi = 300, width = 200, height = 60, units = "mm", bg = "white")
```
...
ggsave("./viz/Figure7.png", dpi = 400, width = 220, height = 60, units = "mm", bg = "white")
ggsave("./figs/Figure7.jpg", dpi = 300, width = 200, height = 60, units = "mm", bg = "white")
# STATS
...
ggsave("./viz/Figure8.png", dpi = 400, units = "mm", width = 220, height = 60, bg = "white")
ggsave("./figs/Figure8.jpg", dpi = 300, units = "mm", width = 200, height = 60, bg = "white")
```
...
ggplot(.) +
  ...
  ggsave("./viz/Figure9.png", dpi = 400, width = 110, height = 60, units = "mm", bg = "white")
ggsave("./figs/Figure9.jpg", dpi = 300, width = 110, height = 60, units = "mm", bg = "white")
```
...
ggsave("./viz/Figure10.png", plot = last_plot(), dpi = 400, width = 130, height = 70, units = "mm")
ggsave("./figs/Figure10.jpg", plot = last_plot(), dpi = 300, width = 130, height = 70, units = "mm")
```
...
ggsave("./viz/Figure11.png", plot = last_plot(), dpi = 400, width = 140, height = 70, units = "mm")
ggsave("./figs/Figure11.jpg", plot = last_plot(), dpi = 300, width = 140, height = 70, units = "mm")
```
...
ggsave("./viz/Figure12.png", dpi = 400, width = 220, height = 60, units = "mm", bg = "white")
ggsave("./figs/Figure12.jpg", dpi = 300, width = 200, height = 60, units = "mm", bg = "white")
```
...
ggplot(t, aes(x = race, y=count , fill=type, alpha = factor(alpharace))) +
 ...
 ggsave('./viz/Figure13.png', dpi = 400, width = 9.5, height = 5, bg = "white") 
  ggsave('./figs/Figure13.jpg', dpi = 300, width = 9.5, height = 5, bg = "white") 
...
ggplot(.) +
  ...
  ggsave("./figs/Figure14.jpg", dpi = 300, width = 150, height = 90, units = "mm")
```
