...
ggplot(data = df) +
  ...
  ggsave('./figs/SI-Figure1.jpg', dpi = 300, width = 110, height = 60, units = "mm", bg = "white")
```
...
ggplot(.) +
  ...
  ggsave('./figs/SI-Figure2.jpg', dpi = 300, width = 110, height = 60, units = "mm", bg = "white")
```
### **SI Figure 3**: 
...
ggplot(.) +
  ...
  ggsave('./viz/SI-Figure3.png', dpi = 400, width = 110, height = 60, units = "mm", bg = "white")
  ggsave('./figs/SI-Figure3.jpg', dpi = 300, width = 110, height = 60, units = "mm", bg = "white") 
...
ggsave("./viz/SI-Figure4.png", dpi = 400, units = "mm", width = 220, height = 60, bg = "white")
ggsave("./figs/SI-Figure4.jpg", dpi = 300, units = "mm", width = 220, height = 60, bg = "white")
```
...
ggsave("./viz/SI-Figure5.png", dpi = 400, width = 150, height = 220, units = "mm", bg = "white")
ggsave("./figs/SI-Figure5.jpg", dpi = 300, width = 150, height = 220, units = "mm", bg = "white")
# race statistics
...
ggsave("./viz/SI-Figure6.png", dpi = 400, units = "mm", width = 220, height = 60, bg = "white")
ggsave("./figs/SI-Figure6.jpg", dpi = 300, units = "mm", width = 220, height = 60, bg = "white")
```
...
ggsave("./figs/SI-Figure7.jpg", dpi = 300, width = 220, height = 120, units = "mm", bg = "white")
```
...
ggsave("./figs/SI-Figure8.jpg", dpi = 300, width = 200, height = 80, units = "mm")
```
...
bea %>% select(c(1:3,11,23)) %>% filter(GeoName == "United States") %>% mutate(prod_exp = (prod_exp)/cash_income*100) %>% 
  ...
  ggsave("./figs/SI-Figure9.jpg", dpi = 300, width = 100, height = 80, units = "mm")
```
...
ggsave("./viz/SI-Figure10.png", dpi = 400, width = 200, height = 100, units = "mm")
ggsave("./figs/SI-Figure10.jpg", dpi = 300, width = 200, height = 100, units = "mm")
```
...
ggplot(.) +
  ...
  ggsave('./viz/SI-Figure11.png', dpi = 400, width = 110, height = 60, units = "mm", bg = "white")
  ggsave('./figs/SI-Figure11.jpg', dpi = 300, width = 110, height = 60, units = "mm", bg = "white")
```
### **SI Figure 12**: 
...
ggplot(.) +
  ...
  ggsave("./figs/SI-Figure12.jpg", dpi = 300, width = 100, height = 80, units = "mm")
...
ggplot(.) +
  ...
  ggsave("./viz/SI-Figure13.png", dpi = 400, width = 140, height = 80, units = "mm")
  ggsave("./figs/SI-Figure13.jpg", dpi = 300, width = 140, height = 80, units = "mm")
```
...
ggplot(.) +
  ...
  ggsave("./viz/SI-Figure14.png", dpi = 400, width = 140, height = 80, units = "mm")
  ggsave("figs/SI-Figure14.jpg", dpi = 300, width = 140, height = 80, units = "mm")
```
...
ggsave("./viz/SIFigure15.png", dpi = 400, width = 220, height = 60, units = "mm", bg = "white")
ggsave("./figs/SIFigure15.jpg", dpi = 300, width = 200, height = 60, units = "mm", bg = "white")
```
