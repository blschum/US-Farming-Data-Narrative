...
```{r}
race <- c("American Indian or Alaska Native", "Asian", "Black or african American", "Native Hawaiian or Other Pacific Islander", "White", "More than one race reported", "Hispanic (all races)")
area <- c()
operations <- c()
